		...
		echo "<div class='wrapperLogin'>";			
			...
			echo "<div class='Aligner'>";
				echo "<form action='shop2.php' method='POST'>";
					echo "<button type='submit' class='btn btn-primary'>zum Warenkorb hinzuf&uuml;gen</button>";
					echo db_show_query($sql,$dbh);
				echo "</form>";
			echo "</div>";			
		echo "</div>";
		db_close($dbh);						echo "<form action='shop1.php' method='POST'>";			echo KategorieComboBox();			echo "<button type='submit' class='btn btn-primary'>Filter anwenden</button>";		echo "<form>";		
	  ?>
</body>
</html>